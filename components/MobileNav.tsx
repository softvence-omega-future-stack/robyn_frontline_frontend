...
const MobileNav = ({
    ...
    return (
        ...
        >
            <aside
                className="absolute right-0 top-0 w-72 h-full bg-white p-6"
            ...
            >
                ...
                <nav className="flex flex-col gap-4">
                    {navLinks.map((item, i) => (
                        <button
                            ...
                            className={`
                            py-2 text-left
                            ${active === item.scrollTo ? 'text-baseBg font-semibold' : 'text-black'}
                        `}
                        >
                            {item.label}
                        </button>
                ...
                <div className="mt-6">
                    <button
                        ...
                        className="block w-full py-2 text-center bg-orange-500 text-white rounded"
                    >
                        Request Case
                    </button>
                </div>
